...
int main(int argc, char *argv[]) {
  ...
  while(1){
    ...
    //Better coding practice
      ...
      //printf("%d | %d\n", quote, doubleQuote);
      if(redirect == 1){
        if (freopen(redirectBuffer, "w", stdout) == NULL) {
        perror("Failed to redirect stdout");
        return EXIT_FAILURE;
        }

        //printf("This text is safely captured in the file.\n");
        printf("%s\n", quotedText);
        continue; 
        //return EXIT_SUCCESS;
      }
      ...
      if(strcmp(input+5, "exit") == 0 ||strcmp(input+5, "echo") == 0||strcmp(input+5, "type") == 0 || strcmp(input+5, "pwd") == 0){
